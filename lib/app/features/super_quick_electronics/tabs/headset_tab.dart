...
class HeadsetsTab extends StatefulWidget {
  const HeadsetsTab({super.key});

  @override
  State<HeadsetsTab> createState() => _HeadsetsTabState();
}

class _HeadsetsTabState extends State<HeadsetsTab> {
  var height, width;
  @override
