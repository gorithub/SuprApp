...
class GamingTab extends StatefulWidget {
  const GamingTab({super.key});

  @override
  State<GamingTab> createState() => _GamingTabState();
}

class _GamingTabState extends State<GamingTab> {
  var height, width;
  @override
