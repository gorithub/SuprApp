...
class LaptopsTab extends StatefulWidget {
  const LaptopsTab({super.key});

  @override
  State<LaptopsTab> createState() => _LaptopsTabState();
}

class _LaptopsTabState extends State<LaptopsTab> {
  var height, width;
  @override
      ...
      child: GridView.count(
        ...
        children: [
          _buildGridProductCard(
            image: 'assets/widelaptop.png',
            title: 'Apple 2020 MacBook',
            subtitle: 'Laptop Apple M1 Chip 1....',
