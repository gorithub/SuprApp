...
class IPadsTab extends StatefulWidget {
  const IPadsTab({super.key});

  @override
  State<IPadsTab> createState() => _IPadsTabState();
}

class _IPadsTabState extends State<IPadsTab> {
  var height, width;
  @override
      ...
      child: GridView.count(
        ...
        children: [
          _buildGridProductCard(
            ...
            title: 'Apple Ipad 10.2 inch 9th',
            subtitle: 'Generation Wifi 64 GB....',
            originalPrice: '',
