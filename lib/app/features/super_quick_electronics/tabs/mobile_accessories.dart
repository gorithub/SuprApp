...
class MobileAccessoriesTab extends StatefulWidget {
  const MobileAccessoriesTab({super.key});

  @override
  State<MobileAccessoriesTab> createState() => _MobileAccessoriesTabState();
}

class _MobileAccessoriesTabState extends State<MobileAccessoriesTab> {
  var height, width;
  @override
      ...
      child: GridView.count(
        ...
        children: [
          _buildGridProductCard(
            ...
            title: 'Bose Quit Comfort ',
            subtitle: 'Wireless Noise Cancel.....',
          ...
          _buildGridProductCard(
            image: 'assets/earburds.png',
            title: 'Apple Airpods',
            subtitle: 'Generation with MagS',
            originalPrice: 'AED 5,117.80',
            discountedPrice: 'AED 3,787.20',
            currencyChanged: true,
          ),
